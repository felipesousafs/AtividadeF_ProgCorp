...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { number: @apartment.number, number_of_rooms: @apartment.number_of_rooms, owner: @apartment.owner, resident: @apartment.resident } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { number: @apartment.number, number_of_rooms: @apartment.number_of_rooms, owner: @apartment.owner, resident: @apartment.resident } }
